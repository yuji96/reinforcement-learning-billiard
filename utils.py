...
class Buffer:
    def __init__(self, actor_model, critic_model, target_actor, target_critic,
                 critic_optimizer, actor_optimizer,
                 num_states, num_actions, buffer_capacity=100000, batch_size=64, **kwargs):
...
def policy(actor_model, state, noise_object, lower_bound, upper_bound, **kwargs):
